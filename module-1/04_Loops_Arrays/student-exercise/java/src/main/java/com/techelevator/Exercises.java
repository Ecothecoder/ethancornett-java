...
public class Exercises {
	...
	/*
	 ...
	 The array will be length 1 or more. so if an array has a 6 in the front or back, true else false
	...
	/*
	 ...
	 sum13([1, 2, 2, 1]) → 6
	 sum13([1, 1]) → 2
	 sum13([1, 2, 2, 1, 13]) → 6 sum of array besides 13 n whats to the right of it
	 */ 
