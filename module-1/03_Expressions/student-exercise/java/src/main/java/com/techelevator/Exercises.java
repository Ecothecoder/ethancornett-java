...
>>>>>>> f65ef8c35a900e9de2196dc95f173cc95ca0dc59
	}
	...
	/*
	 4. Given an int n, return the absolute difference between n 
	 and 21, except return double the absolute
	...
	public boolean parrotTrouble(boolean talking, int hour) {
		...
		return (hour<7&&talking==true||hour>20&&talking&&true);
	}
	...
	/*
	 14. Given 2 int values, return true if they are both in the range 30..40 inclusive, 
	...
	/*
	 15. Given 2 positive int values, return the larger value that is in the range 10..20 
	...
	public int max1020(int a, int b) {
		boolean arange= (a<=20 && a>=10);
		boolean brange= (b<=20 && b>=10);
		if (arange)
			if (a>b || !brange)
				return a;
			else
	...
	/*
	 ...
	 squirrelPlay(95, false) → false 60-90 unless it's summer then 60-100
	...
	public int caughtSpeeding(int speed, boolean isBirthday) {
		if ((speed <= 60)|| (speed <=65 && isBirthday))
			...
			return 1;
		else if ((speed > 80)||((speed >=86&&isBirthday)))
		return 2;
	return 0;
	}
	...
	public boolean in1To10(int n, boolean outsideMode) {
		boolean nRange=(n<=1||n>=10);
		if ((n==1)||(n==10))
			return true;
		if (nRange && outsideMode) 
			return true;
		if (!nRange && !outsideMode)
				return true;
			else
...
>>>>>>> f65ef8c35a900e9de2196dc95f173cc95ca0dc59
	...
	public int teenSum(int a, int b) {
		boolean aRange=(a>12&&a<20);
		boolean bRange=(b>12&&b<20);
		if (aRange||bRange)
			return 19;
		else
			return (a+b);
	...
	/*
	 31. Given three ints, a b c, return true if it is
	...
	/*
	 32. Given three ints, a b c, return true if b is greater than a, 
