...
public class Examples {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("Should I burn down the building? " + burnItDown);
		System.out.println("Should I burn down the building yes or no? " + (burnItDown?"yes":"no"));
		
	}
	
	static boolean shouldBurnDownTheBuilding(int numberOfEmployees, int piecesOfCake) {
		//return (numberOfEmployees > piecesOfCake) ; 
