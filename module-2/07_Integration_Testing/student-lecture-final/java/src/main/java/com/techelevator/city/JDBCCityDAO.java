...
public class JDBCCityDAO implements CityDAO {
	...
	public void update(City city) {
		...
		//bad - we forgot population in update this is to look at our tests
		/*
		String sql = "UPDATE city " +
				 "SET name = ?, countrycode = ?, district = ?" +
			     "WHERE id = ?";		
	    jdbcTemplate.update(sql, city.getName(), city.getCountryCode(), city.getDistrict(), city.getId());
	    */
	}
