...
--(
-- column name datatype(size) maybe NOT NULL
-- Constrint pk, maybe fk
--);

--constraint fk_<this table name>_<parent table name> foreign key (column in this table) references parent table name (column in parent table),

--Alter table table_name
--ADD CONSTRAINT (and then look same)
--ADD column name ...
