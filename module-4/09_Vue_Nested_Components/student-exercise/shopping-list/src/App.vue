<template>
  <div id="app">
    ...
    <Shopping-Search @filter="handleFilter"/>
    <Shopping-List title="Groceries" :data="groceries" :filtered-text="searchText"/>
    <Shopping-List title="CostCo" :data="costco" :filtered-text="searchText"/>
    <Shopping-List title="Target" :data="target" :filtered-text="searchText"/>
  </div>
</template>
