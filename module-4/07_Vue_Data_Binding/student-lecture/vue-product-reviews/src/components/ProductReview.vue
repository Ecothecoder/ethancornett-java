...
export default {
    ...
    computed: {
        ...
        numberOfOneStarReviews(){
            return this.reviews.reduce((count, review)=> review.rating ===1? count+1:count,0)

        },        numberOfTwoStarReviews(){
            return this.reviews.reduce((count, review)=> review.rating ===2? count+1:count,0)
    ...
    methods: {
        numberOfReviews(starCount){
            return this.reviews.reduce((count, review) => review.rating === starCount? count+1: count, 0)
        }
    }
}
</script>
