 ...
 */
function printParameters(param1, param2, ...otherStuff) {
  console.log(`The value of param1 is ${param1}`);
  console.log(`The value of param2 is ${param2}`);
  console.log(`The value of the third parameter is ${arguments[2]}`);
  console.log(`The value of otherStuff is ${otherStuff[1]}`);
}
...
console.log(names.join(', '));
  //.push() & .pop()
//push and pop add and delete the last one
//let n = names.pop, log n and it will show who is popped
  //.shift() & .unshift()
