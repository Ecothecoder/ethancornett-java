...
if (localStorage.getItem('storedReviews') != null) {
  reviews = JSON.parse(localStorage.getItem('storedReviews'));
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  descrip.addEventListener('click', toggleDescriptionEdit);
 ...
 *
 * @param {HTMLElement} textBox the description text box
...
function saveReview() {
  ...
  if (newReview.reviewer && newReview.review && newReview.title) {
    reviews.push(newReview);

    localStorage.setItem('storedReviews', JSON.stringify(reviews));
