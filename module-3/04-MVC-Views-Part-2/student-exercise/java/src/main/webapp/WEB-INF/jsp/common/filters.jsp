...
<div id="filter-options">
	<h3>Refine By</h3>
	<ul>
		<li><a href="${param.baseRoute}?maxPrice=25">Under $25</a></li>
		<li><a href="${param.baseRoute}?maxPrice=50&minPrice=25">$25 to $50</a></li>
		<li><a href="${param.baseRoute}?minPrice=50">$50 &amp; Above</a></li>
	</ul>
	<p>Avg. Review</p>
	<ul>
		<li>
