...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
	...
	<fmt:formatNumber var="myNumber" value="3.1456789" maxFractionDigits="2"/>
	
	<div>${myNumber}</div>
	
	<p>The Solar System formed <fmt:formatNumber maxFractionDigits="0">4.6</fmt:formatNumber> billion years ago from the
		...
		of hydrogen and helium; the ${myNumber} outermost planets, Uranus and Neptune,
