...
<c:param name="pageTitle">The Solar System</c:param>
</c:import>


	<p>The Solar System formed <fmt:formatNumber maxFractionDigits="0">4.6</fmt:formatNumber> billion years ago from the gravitational
	collapse of a giant interstellar molecular cloud. The vast majority of
	the system's mass is in the Sun, with most of the remaining mass
	...
	giants, being composed largely of substances with relatively high
	melting points compared with hydrogen and helium, called ices, such as
	water, ammonia and methane. All planets have almost circular orbits
	that lie within a nearly flat disc called the ecliptic.</p>
	...
	<div class="planet">
		...
		<p>Earth is the third planet from the Sun, the densest planet in
			...
			are still an estimated millions of extant species, of which about
	...
	<div class="planet">
		...
		<p>Uranus is the seventh planet from the Sun. It has the
			...
			in the Solar System, with a minimum temperature of 49K (224.2
	...
	<div class="planet">
		...
		<p>Neptune is the eighth and farthest planet from the Sun in the
			...
			Sun at an average distance of 30.1 astronomical units.</p>
